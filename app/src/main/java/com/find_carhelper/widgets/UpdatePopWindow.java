...
public class UpdatePopWindow extends BasePopupWindow implements View.OnClickListener,MarkerOrderPopWindow.getdata {
...
private OptionsPickerView mOptionsPickerView;
    ...
    public UpdatePopWindow(Context context, MarkerOrderPopWindow.getdata getdata) {
        super(context);
    ...
    public View onCreateContentView() {
        return createPopupById(R.layout.update_pop);
    }
